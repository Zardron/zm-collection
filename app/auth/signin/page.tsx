  ...
  return (
    <div className={`min-h-screen flex ${theme === 'dark' ? 'bg-[#0B0B0B]' : 'bg-[#F5F3EE]'}`}>
      ...
      <div className="hidden lg:flex lg:w-1/2 relative overflow-hidden">
        ...
        {/* Animated Gold Orbs */}
        <div className="absolute top-20 left-20 w-72 h-72 bg-[#D4AF37]/20 rounded-full blur-3xl animate-pulse" />
        <div className="absolute bottom-32 right-16 w-96 h-96 bg-[#E6C77A]/15 rounded-full blur-3xl animate-pulse delay-1000" />
        <div className="absolute top-1/2 left-1/3 w-48 h-48 bg-[#D4AF37]/10 rounded-full blur-2xl animate-pulse delay-500" />
        
        {/* Decorative Lines */}
        <div className="absolute inset-0 overflow-hidden">
          <div className="absolute top-0 left-1/4 w-px h-full bg-gradient-to-b from-transparent via-[#D4AF37]/30 to-transparent" />
          <div className="absolute top-0 right-1/3 w-px h-full bg-gradient-to-b from-transparent via-[#E6C77A]/20 to-transparent" />
          <div className="absolute top-1/3 left-0 w-full h-px bg-gradient-to-r from-transparent via-[#D4AF37]/20 to-transparent" />
        </div>
        ...
        <div className="relative z-10 flex flex-col justify-center items-center w-full p-12 text-center">
          ...
          <p className="text-[#F5F3EE]/70 text-lg max-w-md animate-fade-in" style={{ animationDelay: '0.4s' }}>
            Sign in to access your exclusive collection of premium beauty products and personalized recommendations.
          </p>
          
          {/* Decorative Diamond Pattern */}
          <div className="mt-12 flex items-center gap-4 animate-fade-in" style={{ animationDelay: '0.6s' }}>
      ...
      <div className={`w-full lg:w-1/2 flex items-center justify-center p-8 ${
        ...
        <div className="w-full max-w-md space-y-8 animate-fade-in">
            ...
            <div className="space-y-2">
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className={`w-full pl-12 pr-4 py-3.5 rounded-xl border-2 transition-all duration-300 focus:outline-none focus:ring-0 ${
                    theme === 'dark'
                      ? 'bg-[#1A1A1A] border-[#E6C77A]/20 text-[#F5F3EE] placeholder-[#F5F3EE]/40 focus:border-[#D4AF37] focus:bg-[#1A1A1A]/80'
                      : 'bg-white border-[#E6C77A]/30 text-[#0B0B0B] placeholder-[#0B0B0B]/40 focus:border-[#D4AF37] focus:bg-white'
                  }`}
            ...
            <div className="space-y-2">
              ...
              <div className="relative">
                ...
                <input
                  ...
                  onChange={handleChange}
                  className={`w-full pl-12 pr-12 py-3.5 rounded-xl border-2 transition-all duration-300 focus:outline-none focus:ring-0 ${
                    theme === 'dark'
                      ? 'bg-[#1A1A1A] border-[#E6C77A]/20 text-[#F5F3EE] placeholder-[#F5F3EE]/40 focus:border-[#D4AF37] focus:bg-[#1A1A1A]/80'
                      : 'bg-white border-[#E6C77A]/30 text-[#0B0B0B] placeholder-[#0B0B0B]/40 focus:border-[#D4AF37] focus:bg-white'
                  }`}
              ...
              <label className="flex items-center gap-3 cursor-pointer group">
                <div className="relative">
                  ...
                  <div className={`w-5 h-5 rounded border-2 transition-all duration-200 peer-checked:bg-[#D4AF37] peer-checked:border-[#D4AF37] ${
                    ...
                    <svg 
                      className="w-full h-full text-[#0B0B0B] opacity-0 peer-checked:opacity-100 transition-opacity p-0.5" 
                      fill="none" 
                      stroke="currentColor" 
                      viewBox="0 0 24 24"
                    >
                ...
                <span className={`text-sm ${theme === 'dark' ? 'text-[#F5F3EE]/70' : 'text-[#0B0B0B]/70'} group-hover:text-[#D4AF37] transition-colors`}>
                  Remember me
                </span>
              </label>
              <Link 
                href="/auth/forgot-password" 
                className="text-sm text-[#D4AF37] hover:text-[#E6C77A] transition-colors font-medium"
              >
                Forgot password?
              </Link>
            </div>
          ...
          <div className="grid grid-cols-2 gap-4">
            <button className={`flex items-center justify-center gap-3 py-3.5 rounded-xl border-2 transition-all duration-300 hover:scale-[1.02] ${
              theme === 'dark'
