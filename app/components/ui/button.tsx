...
const buttonVariants = cva(
  "inline-flex items-center justify-center whitespace-nowrap rounded-md text-sm font-medium transition-all duration-200 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 cursor-pointer",
  {
    variants: {
      variant: {
        default:
          "bg-[var(--accent)] text-[var(--primary-black)] hover:bg-[var(--accent-hover)] shadow-sm",
        destructive:
          "bg-red-600 text-white hover:bg-red-700 shadow-sm",
        outline:
          "border border-[var(--border)] bg-transparent hover:bg-[var(--accent)]/10 text-[var(--foreground)]",
        secondary:
          "bg-[var(--card-bg)] text-[var(--foreground)] hover:bg-[var(--card-bg)]/80 border border-[var(--border)]/30",
        ghost:
